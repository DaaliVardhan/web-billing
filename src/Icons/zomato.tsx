    ...
    >
      <g>
        <path
          ...
          className="st0"
          style={{ fill: "#E23744" }}
          d="M82.3,71h475.3c6.8,0,12.3,5.5,12.3,12.3v475.3c0,6.8-5.5,12.3-12.3,12.3H82.3
		c-6.8,0-12.3-5.5-12.3-12.3V83.3C70,76.5,75.5,71,82.3,71z"
        />
        <g id="Group" transform="translate(31.000000, 221.000000)">
          <path
            id="zomato-copy-10"
            className="st1"
            style={{ fill: "#FFFFFF" }}
            d="M136.6,75.4l-0.4,12.7l-33.1,36c13.8,0,22.6-0.1,27.6-0.4c-1.5,6.8-2.7,12.4-3.9,20.8
          ...
          <path
            ...
            className="st1"
            style={{ fill: "#FFFFFF" }}
            d="M347.5,132c8.4-1,14.1-9.1,15.5-17.1l0.2-2.2c-3.6-0.8-8.8-1.4-13.8-0.8
